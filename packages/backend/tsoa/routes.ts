...
import { expressAuthentication } from './../src/security/auth.handler';
...
const models: TsoaRoute.Models = {
    ...
    "Pick_User.Exclude_keyofUser.id-or-role-or-verified__": {
        "dataType": "refAlias",
        "type": {"dataType":"nestedObjectLiteral","nestedProperties":{"email":{"dataType":"string","required":true},"password":{"dataType":"string","required":true},"name":{"dataType":"string","required":true}},"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "Omit_User.id-or-role-or-verified_": {
        "dataType": "refAlias",
        "type": {"ref":"Pick_User.Exclude_keyofUser.id-or-role-or-verified__","validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "UserCreationRequest": {
        "dataType": "refAlias",
        "type": {"ref":"Omit_User.id-or-role-or-verified_","validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "APIErrorCode": {
        "dataType": "refAlias",
    ...
    "APIErrorType": {
        "dataType": "refAlias",
        "type": {"dataType":"nestedObjectLiteral","nestedProperties":{"message":{"dataType":"string"},"code":{"ref":"APIErrorCode","required":true}},"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        app.get('/api/users/current',
            authenticateMiddleware([{"token":["user:current.read"]}]),
        ...
        app.get('/api/users',
            authenticateMiddleware([{"token":["user.read"]}]),
            ...(fetchMiddlewares<RequestHandler>(UserController)),
        ...
        const argsAuthController_signup: Record<string, TsoaRoute.ParameterSchema> = {
                ...
                errUserAlreadyExisted: {"in":"res","name":"409","required":true,"ref":"APIErrorType"},
        };
        ...
        app.get('/api/auth/verify/:token',
            ...
            async function AuthController_verifyAccount(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsAuthController_verifyAccount, request, response });
        ...
        const argsAuthController_signin: Record<string, TsoaRoute.ParameterSchema> = {
                ...
                errUserAlreadyExisted: {"in":"res","name":"401","required":true,"ref":"APIErrorType"},
                errUserNotVerified: {"in":"res","name":"401","required":true,"ref":"APIErrorType"},
        };
